...
const EdinetHeadline = () => {
    console.log("modelcule headline->index")

    const [columnDefs, setColumnDefs] = useState<ColDef[]>([
        { field: 'submit_datetime', headerName: 'Submit Date', filter: 'agDateColumnFilter' },
        { field: 'doc_id', headerName: 'Document ID', filter: 'agTextColumnFilter', },
        { field: 'edinet_code', headerName: 'Edinet Code', filter: 'agTextColumnFilter', },
        { field: 'filer_name', headerName: 'Filer Name', filter: 'agTextColumnFilter', },
    ]);
    ...
    const headlineDatasource = {
        getRows(params: IGetRowsParams) {
            setTimeout(function () {
                ...
                const promise = fetch('api/headline?startRow=' + startRow + '&endRow=' + endRow, { method: 'GET' })
    ...
    const onGridReady = useCallback((params: GridReadyEvent) => {
        ...
        var dataSource: IDatasource = headlineDatasource
